...
new_branch="update_${source_branch}_to_api_version_${version}"
...
curl --request POST \
     --data "source_branch=${new_branch}&target_branch=${source_branch}&title=Change ${source_branch} Source API Version to ${version}" \
